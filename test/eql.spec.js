...
tests.push(['eql("hello world", /he.+ld/)', 'hello world', /he.+ld/]);
tests.push(['eql("hello world", /hx.+ld/)', 'hello world', /hx.+ld/, true]);

tests.push(['eql({ a: /he.+ld/, b: "bye world" }, { b: /b.e w.rld/, a: "hello world" })', { a: /he.+ld/, b: "bye world" }, { b: /b.e w.rld/, a: "hello world" }]);
tests.push(['eql({ a: /he.+ld/, b: "byye world" }, { b: /b.e w.rld/, a: "hello world" })', { a: /he.+ld/, b: "byye world" }, { b: /b.e w.rld/, a: "hello world" }, true]);

tests.push(['eql({ a: function(v) {return v > 5;}}, { a: 6 })', { a: function(v) {return v > 5;}}, { a: 6 }]);
tests.push(['eql({ a: function(v) {return v < 5;}}, { a: 6 })', { a: function(v) {return v < 5;}}, { a: 6 }, true]);
...
describe('deep-equal', function () {
    tests.forEach(function (test, i) {
        ...
        it(title, function () {
            if (negate) {
                eql(test[1], test[2]).should.not.be.true();
            } else {
                eql(test[1], test[2]).should.be.true();
            }
        });
    });
});
